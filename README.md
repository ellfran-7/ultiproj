...
# mycomp <img src="man/figures/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
...
- [`DESCRIPTION`](https://github.com/ellfran-7/mycomp/tree/main/DESCRIPTION):
  contains project metadata (authors, date, dependencies, etc.)

- [`make.R`](https://github.com/ellfran-7/mycomp/tree/main/make.R): main
  R script to run the entire project

- [`R/`](https://github.com/ellfran-7/mycomp/tree/main/R): contains R
...
Launch the
[`make.R`](https://github.com/ellfran-7/mycomp/tree/main/make.R) file
with:
...
Guidelines](https://github.com/ellfran-7/mycomp/blob/main/CONTRIBUTING.md).
